    ...
    <div className="pt-48 pb-24 px-6">
      <div className="max-w-7xl mx-auto">
        <motion.div
          ...
          className="mb-32"
        >
          <h1 className="text-7xl md:text-9xl font-light tight-tracking mb-16">Our <span className="font-black italic text-brand-accent">story</span></h1>
        ...
        <div className="bg-black text-white p-20 md:p-32 rounded-[60px] relative overflow-hidden">
          <div className="absolute top-0 right-0 w-96 h-96 bg-brand-accent/20 blur-[120px] -mr-48 -mt-48" />
          <h2 className="text-5xl md:text-7xl font-light mb-20 tight-tracking font-serif italic">Our philosophy</h2>
