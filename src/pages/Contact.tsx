  ...
  return (
    <div className="pt-40 pb-24 px-6">
      <div className="max-w-7xl mx-auto">
        <h1 className="text-6xl md:text-8xl font-black tight-tracking mb-24">Get In Touch</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-24">
          ...
          >
            <div className="space-y-4">
              ...
              <input type="text" className="w-full bg-brand-bg border-b border-black/10 py-4 px-6 focus:outline-none focus:border-black transition-colors rounded-t-lg" placeholder="John Doe" />
            </div>
            <div className="space-y-4">
              <label className="text-[10px] font-bold uppercase tracking-widest text-brand-muted">Email Address</label>
              <input type="email" className="w-full bg-brand-bg border-b border-black/10 py-4 px-6 focus:outline-none focus:border-black transition-colors rounded-t-lg" placeholder="john@example.com" />
            </div>
            <div className="space-y-4">
              <label className="text-[10px] font-bold uppercase tracking-widest text-brand-muted">Your Message</label>
              <textarea rows={4} className="w-full bg-brand-bg border-b border-black/10 py-4 px-6 focus:outline-none focus:border-black transition-colors resize-none rounded-t-lg" placeholder="Tell us about your project..." />
            </div>
        ...
        >
          <div className="flex flex-col md:flex-row justify-between items-end gap-8 mb-12">
            <h2 className="text-4xl md:text-6xl font-black tight-tracking">Our Location</h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div className="bg-black text-white p-12 rounded-3xl flex flex-col justify-between">
              <div>
                <h3 className="text-2xl font-bold mb-8 uppercase tracking-tighter">Headquarters</h3>
